...
* Use Python 3.8.0 since Python 3.7 gives libusb error
Download and install Python 3.8.0 from https://www.python.org/. For Windows user, please check the "Add to PATH" box when installing.
