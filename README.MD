...
For Windows download and install [GNUwin Make (for Windows)](http://gnuwin32.sourceforge.net/packages/make.htm). Add the path to your GNU Make executable to your "PATH" environment variable. For example:
